...
public class AppConfig {
    ...
    public Prenotazione prenotazioneUno(){
        return new Prenotazione(utenteUno(),postazioneUno(), LocalDate.now());
    }
    @Bean(name = "prenotazioneDue")
    public Prenotazione prenotazioneDue(){
        return new Prenotazione(utenteDue(),postazioneDue(), LocalDate.now());
    }
    @Bean(name = "prenotazioneTre")
    public Prenotazione prenotazioneTre(){
        return new Prenotazione(utenteTre(),postazioneTre(), LocalDate.now());
    }
